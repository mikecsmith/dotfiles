...
defaults write com.apple.dock autohide -bool false # Do not auto-hide the Dock
...
defaults write com.apple.dock orientation -string "bottom" # Set Dock position to bottom of the screen
defaults write com.apple.dock tilesize -int 48 # Set Dock tile size
