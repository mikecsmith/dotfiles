local LazyUtil = require("lazy.core.util") or {}

---@class fathom: LazyUtilCore
---@field cmp fathom.cmp
---@field config fathom.config
---@field format fathom.format
---@field lsp fathom.lsp
---@field mini fathom.mini
---@field plugin fathom.plugin
---@field root fathom.root
---@field toggle fathom.toggle
---@field ui fathom.ui
---@field wezterm_nav fathom.wezterm_nav
local M = {}

-- Exports core lazy utilities and all subfiles on call
setmetatable(M, {
...
for _, level in ipairs({ "info", "warn", "error" }) do
  M[level] = function(msg, opts)
    opts = opts or {}
    opts.title = opts.title or "Fathom"
