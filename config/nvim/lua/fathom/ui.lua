...
function M.foldtext()
  ...
  table.insert(ret, { " " .. Fathom.config.icons.misc.dots })
...
function M.statuscolumn()
  ...
  local show_open_folds = vim.g.fathom_statuscolumn and vim.g.fathom_statuscolumn.folds_open
  local use_githl = vim.g.fathom_statuscolumn and vim.g.fathom_statuscolumn.folds_githl
  ...
  if show_signs then
    ...
    vim.api.nvim_win_call(win, function()
      ...
      elseif
        show_open_folds
        and not Fathom.ui.skip_foldexpr[buf]
